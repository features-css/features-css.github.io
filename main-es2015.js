...
let AppComponent = class AppComponent {
    ...
    ngAfterViewInit() {
        const pleaseHelpMeShowedOnce = localStorage.getItem('pleaseHelpMeShowedOnce');
...
// Root url
//
class ModuleUrlsRootUrl {
    constructor(urlNoSlash) {
...
ModuleUrlsRootUrl.ctorParameters = () => [
    { type: String }
];
//
// Item
//
class ModuleUrlsItem {
    constructor(moduleUrls, url) {
    ...
    get url() {
        ...
        if (this._moduleUrls.context instanceof ModuleUrlsRelativeContext) {
            ...
            const absoluteContext = this._moduleUrls.context;
            url = `${absoluteContext.rootUrl.urlWithSlash}${this._url}`;
        }
        return url;
    }
}
ModuleUrlsItem.ctorParameters = () => [
    { type: ModuleUrls },
    { type: String }
];
//
// Relative context
//
class ModuleUrlsRelativeContext {
}
//
// Absolute context
//
class ModuleUrlsAbsoluteContext {
    constructor(rootUrlNoSlash) {
        this.rootUrl = new ModuleUrlsRootUrl(rootUrlNoSlash);
    }
}
ModuleUrlsAbsoluteContext.ctorParameters = () => [
    { type: String }
];
//
// Module urls
...
class ModuleUrls {
    ...
    rootUrl(withSlash) {
        ...
        if (this.context instanceof ModuleUrlsAbsoluteContext) {
            const absoluteContext = this.context;
            const rootUrl = absoluteContext.rootUrl;
            result = withSlash ? rootUrl.urlWithSlash : rootUrl.urlNoSlash;
        }
        return result;
    }
}
ModuleUrls.ctorParameters = () => [
    { type: undefined }
];
...
// Urls class
//
class UserModuleUrls extends _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrls"] {
    constructor() {
        super(...arguments);
        this.aboutFeaturesCss = new _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrlsItem"](this, 'about-features-css');
        this.featuresCssTeam = new _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrlsItem"](this, 'features-css-team');
        this.aboutSaveProject = new _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrlsItem"](this, 'about-save-project');
        this.saveTeam = new _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrlsItem"](this, 'save-team');
    }
}
//
// Relative urls
//
const relativeUrls = new UserModuleUrls(new _shared_logic_module_urls__WEBPACK_IMPORTED_MODULE_7__["ModuleUrlsRelativeContext"]());
//
// Routes
//
const routes = [
